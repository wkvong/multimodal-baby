...
for checkpoint in ${frozen_pretrained_checkpoints[@]}; do
    srun python linear_decoding.py --train_dir '/misc/vlgscratch4/LakeGroup/shared_data/S_multimodal/eval/dev' --test_dir '/misc/vlgscratch4/LakeGroup/shared_data/S_multimodal/eval/test' --checkpoint ${checkpoint} --num-classes 22 --epochs 100
    done
